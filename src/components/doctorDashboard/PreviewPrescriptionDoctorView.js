...
const PreviewPrescriptionDoctorView = (props) => {
  ...
  useEffect(() => {
    ...
    fetchprescription();
    fetchpatient();
  }, [ props.healthID, props.prescriptionID]);
    ...
    >
      <div className="w-3/4  ml-32 bg-white shadow-xl p-8 mb-4 mt-6">
        ...
        <div className="grid grid-cols-3 mt-4">
          <div className="col-span-2">
            ...
            <div className="flex">
              ...
              <h4>{`${patient.address.building},  ${patient.address.city},   ${patient.address.district},   ${patient.address.pincode}`}</h4>
            </div>
          </div>
          <div>
            <div className="flex">
        ...
        <div className="mb-2">
          ...
          <button className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded" onClick={printPrescription}>Print Prescription</button>
