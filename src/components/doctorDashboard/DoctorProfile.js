...
import patient_card_profile from "../../assets/img/dashboard/doctor_profile.jpeg";
        ...
        <div className="my-2">
          <div className="p-8 m-2 bg-white shadow-md w-2/3 rounded-md">
            <div className="flex mt-3">
              ...
              <div className="ml-4">
                <h2>
                  {`${doctor.address.building},  ${doctor.address.city},   ${doctor.address.district},   ${doctor.address.pincode}`}
                </h2>
              </div>
            </div>
          ...
          <div className="p-8 m-2 bg-white shadow-md w-2/3 rounded-md mt-10">
            ...
            <div className="flex mt-6">
              ...
              <div className="ml-4 ">
                <h2>
                  {`${doctor.orgAddress.building},  ${doctor.orgAddress.city},  ${doctor.orgAddress.district},  ${doctor.orgAddress.pincode}`}
                </h2>
              </div>
            </div>
          </div>
