...
const DashboardSidebar = (props) => {
      ...
      <div className="side_bar bg-white shadow col-span-2">
        ...
        <nav>
          <Link
            ...
            className={Toggle === "Dashboard" ? "text-gray-900" : "text-gray-400"}
          >
          ...
          <div className="p-4">
            ...
            <div className="grid grid-rows-2 gap-4 font-bold font-poppins mt-4">
              <Link
                ...
                className={Toggle === "Patient_history" ? "text-gray-900" : "text-gray-400"}
              >
              ...
              <Link
                ...
                className={Toggle === "Patient_profile" ? "text-gray-900" : "text-gray-400"}
              >
                <div className="flex p-2">
                  <img
                    src={patient_profile}
  ...
  <a
    href="http://127.0.0.1:5002/" // Replace with the URL you want to navigate to
    target="_blank" // Open the link in a new tab
    rel="noopener noreferrer" // Required for security reasons
    className="font-bold text-lg bg-green-800 text-white px-2 py-2 rounded-md"
    // Adjust the padding (px-4 py-2) and rounded corners (rounded-md) as needed
  >
    Check Eye
  </a>
</div>
