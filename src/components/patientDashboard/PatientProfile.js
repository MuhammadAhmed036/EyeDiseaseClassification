...
import patient_card_profile from "../../assets/img/dashboard/patientnewimg.webp";
          ...
          <div className="p-8 m-2 bg-white shadow-md w-2/3 rounded-md">
            <div className="flex mt-3">
              ...
              <div className="ml-4">
                <h2>
                  {" "}
                  {`${patient.address.building},  ${patient.address.city},  ${patient.address.district}, ${patient.address.pincode}`}
                </h2>
              </div>
            </div>
          </div>
          <div className="p-8 m-2 bg-white shadow-md w-2/3 rounded-md mt-10">
            ...
            <div className="flex mt-6">
              ...
              <div className="ml-4">
                <h2>
                  {" "}
                  {`${patient.contactPerson.address.building},  ${patient.contactPerson.address.city},  ${patient.contactPerson.address.district}, ${patient.contactPerson.address.pincode}`}
                </h2>
              </div>
            </div>
          </div>
