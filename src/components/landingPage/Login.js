  ...
  return (
    <div className="bg-white flex flex-col justify-items-center items-center py-4 px-4 rounded shadow-md lg:w-3/4 w-full my-7 ml-auto ">
      ...
      <div className="flex flex-wrap justify-center items-center gap-4 mb-6">
        <button
          className={`py-2 px-8 text-lg font-poppins font-medium cursor-pointer rounded bg-primary ${
            Toggle === "Patient" && "font-semibold"
          }`}
          onClick={() => {
            setToggle("Patient");
            setUsername("");
      ...
      <form className="w-full px-8" onSubmit={handleLogin}>
        ...
        >
          {Toggle === "Patient" ? "CNIC NO" : "Email"}
        </label>
        <input
          type="text"
          name="username"
          id="username"
          className="font-poppins px-3 py-2 bg-bgsecondary rounded outline-none w-full"
          value={username}
        ...
        {Loading ? (
          ...
          <button
            type="submit"
            className="text-lg mt-10  bg-primary py-1 px-3 rounded font-semibold font-poppins shadow-sm hover:bg-bgsecondary w-full"
          >
            Login
          </button>
        )}
